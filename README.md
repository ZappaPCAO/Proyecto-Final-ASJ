...
- Create una base de datos llamada
```SQL
  CREATE DATABASE t-zappa
```
...
- Insertar  **states**  **SOLO PARA ARGENTINA**
```sql
INSERT INTO states (name, country_id) VALUES 
	...
	('Tucumán',5);
```
- Insertar  **cities**  **SOLO PARA ARGENTINA**
```sql
...
```bash 
-   **Llegar hasta esta carpeta**
	cd t-zappa.front-end  
...
- Insertar algunas **categories**     desde el FRONT
- Insertar algunas  **providers**     desde el FRONT
- Insertar algunas   **articles**     desde el FRONT
- Insertar algunas **purchaseOrders** desde el FRONT
...
#### Obtener proveedor con mas ordenes de compra

```http
  GET /api/articles/purchase-orders/top-1
```

#### Obtener proveedores por sector

```http
  GET /api/articles/sector/${id}
```

| Parámetro | Tipo     | Descripción                       |
| :-------- | :------- | :-------------------------------- |
| `id`      | `Integer` | **Obligatorio**. ID del Sector a buscar |


#### Obtener proveedores activos

```http
  GET /api/articles/actives
```

#### Similares para purchase-orders

## Desarrollado por

Este proyecto fue desarrollado por: **Tomás Zappalá**